...
public class NeuralNetworkFactoryFullBodyIml implements NeuralNetworkFactory {
    @Override
        ...
        return new NeuralNetworkMethod() {
            ...
            public OutputSignal evaluate(InputSignal inputSignal) {
                return new OutputSignal() {
                    @Override
                    public void log() {
                        System.out.println("input signal evaluated by RNN for full body");
                    }
                };
            }
        };
        ...
        return new NeuralNetworkMethod() {
            ...
            public OutputSignal evaluate(InputSignal inputSignal) {
                return new OutputSignal() {
                    @Override
                    public void log() {
                        System.out.println("input signal evaluated by TGCN for full body");
                    }
                };
            }
        };
        ...
        return new NeuralNetworkMethod() {
            ...
            public OutputSignal evaluate(InputSignal inputSignal) {
                return new OutputSignal() {
                    @Override
                    public void log() {
                        System.out.println("input signal evaluated by GRU for full body");
                    }
                };
            }
        };
